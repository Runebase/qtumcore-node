...
module.exports.services.Bitcoin = require('./lib/services/runebased');
module.exports.services.Runebase = require('./lib/services/runebased');
...
module.exports.lib = require('runebasecore-lib');
