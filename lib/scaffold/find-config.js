...
/**
 * Will return the path and runebasecore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'runebasecore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'runebasecore-node.json'))
  };
}
