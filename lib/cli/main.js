...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `runebasecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ runebasecore-node add wallet-service');
      console.log('    $ runebasecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ runebasecore-node remove wallet-service');
      console.log('    $ runebasecore-node remove insight-api');
      console.log();
    });
